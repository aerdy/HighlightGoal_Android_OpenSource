...
public class HighlightAdapter extends RecyclerView.Adapter<HighlightHolder> {
    ...
    HighlightHolder feedListRowHolder;
    Cache_String cache_string;
    String date1;
    Dialog dialog;
    public HighlightAdapter(Activity context, List<HighlightItem> feedItemList, List<HighlightItem> feedItemListurl) {
    ...
    @Override
    public HighlightHolder onCreateViewHolder(final ViewGroup viewGroup, final int i) {
        View header = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.item_highlight, viewGroup, false);
        HighlightHolder mh = new HighlightHolder(header);
        return mh;
    }

    @Override
    public void onBindViewHolder(final HighlightHolder feedListRowHolder, final int i) {
