package com.necisstudio.highlightgoal.manipulation;

/**
 * Created by jarod on 5/5/15.
 */
...
public class DropdownAnimation extends Animation {
     ...
     */
    public DropdownAnimation(View view, int duration, int type,Activity activity) {
