 ...
 */
public class TeamChampionsUtils {
    int a = 0;
    Activity activity;
    Cache_String cache_string;

    public TeamChampionsUtils(final Activity activity, final List<TeamChampion> listitem, final TeamChampionsAdapter adapter, final ProgressBar progressBar) {
        ...
        String url = new XXmdk().teamchampiuon();
