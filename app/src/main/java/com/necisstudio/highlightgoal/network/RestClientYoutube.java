...
public class RestClientYoutube extends XXmdk{
    ...
    public interface ApiInterface {
        ...
        Call<ResponseBody> setPost(@Url String url, @FieldMap Map<String, String> a);
        ...
        @Multipart
        @POST
        Call<ResponseBody> upload(@Url String url, @PartMap Map<String, RequestBody> file);
